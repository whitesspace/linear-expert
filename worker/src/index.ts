    ...
    if (url.pathname === "/healthz" && request.method === "GET") {
      return json({
        ...
        routes: {
          ...
          internalAgentRunsList: "GET /internal/agent-runs?status=pending&limit=25",
          internalAgentRunsClaim: "POST /internal/agent-runs/:id/claim",
          internalAgentRunsResult: "POST /internal/agent-runs/:id/result",
